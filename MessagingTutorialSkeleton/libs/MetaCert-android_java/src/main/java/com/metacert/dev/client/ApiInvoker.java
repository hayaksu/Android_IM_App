...
public class ApiInvoker {
  ...
  // authentication
  public static volatile String apiKey = "<YOUR API KEY>";
  public static volatile String apiKeyType = "header";
  public static volatile String apiKeyName = "apikey";
  ...
  public String invokeAPI(String host, String path, String method, Map<String, String> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String contentType, boolean requireAuth) throws ApiException {
    ...
    if (requireAuth == false) {
        ...
        headerParams.put("Authorization", "Basic " + new String(Base64.encode((username + ":" + password).getBytes(), Base64.DEFAULT)));
    }
    ...
    // user agent
    headers.put("User-Agent", "Swagger/Android/0.0.1/dev");

    HttpResponse response = null;
    try{
      if("GET".equals(method)) {
        HttpGet get = new HttpGet(url);
        // don't hardcode Accept
        ...
        if ("application/x-www-form-urlencoded".equals(contentType)) {
          ...
          post.setEntity(new StringEntity(formParamBuilder.toString(), "UTF-8"));
        } 
        else if (body != null) {
          // file upload
        ...
        if ("application/x-www-form-urlencoded".equals(contentType)) {
          ...
          put.setEntity(new StringEntity(formParamBuilder.toString(), "UTF-8"));
        } 
        else if(body != null) {
          put.setHeader("Content-Type", contentType);
        ...
        if ("application/x-www-form-urlencoded".equals(contentType)) {
          ...
          patch.setEntity(new StringEntity(formParamBuilder.toString(), "UTF-8"));
        } 
        else if (body != null) {
          patch.setHeader("Content-Type", contentType);
